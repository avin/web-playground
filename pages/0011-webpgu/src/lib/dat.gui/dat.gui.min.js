...
!(function (e, t) {
  ...
  function h(e, t, n) {
    if (
      ...
      const o = new Q(n.object, n.property, {
        min: n.__min,
        max: n.__max,
        step: n.__step,
      });
        ...
        : n instanceof Z
          ...
          : n instanceof $ &&
            ...
            (n.updateDisplay = S.compose(
              (e) => (t.style.borderLeftColor = n.__color.toString()),
              e,
              n.updateDisplay,
            )),
            n.updateDisplay());
    n.setValue = S.compose(
      (t) =>
        e.getRoot().__preset_select && n.isModified() && _(e.getRoot(), !0),
      t,
      n.setValue,
    );
  }
  ...
  function v(e) {
    ...
    if (
      ...
      ((document.getElementById('dg-save-locally').style.display = 'block'),
        localStorage.getItem(m(e, 'isLocal')) === 'true' &&
    ...
    extend(e) {
      return (
        this.each(
          k.call(arguments, 1),
          function (t) {
            (this.isObject(t) ? Object.keys(t) : []).forEach((n) => {
          ...
          read(e) {
            ...
            return (
              t !== null && {
                space: 'HEX',
                hex: parseInt(
                  `0x${t[1].toString()}${t[1].toString()}${t[2].toString()}${t[2].toString()}${t[3].toString()}${t[3].toString()}`,
                  0,
                ),
              }
            );
    ...
    },
    {
      ...
      conversions: {
        RGB_ARRAY: {
          read(e) {
            return (
              e.length === 3 && { space: 'RGB', r: e[0], g: e[1], b: e[2] }
            );
          },
          write(e) {
            return [e.r, e.g, e.b];
