...
!(function (e, t) {
  ...
  function t(e, t) {
    ...
    const o = Math.round(e.r);
    const i = Math.round(e.g);
    const r = Math.round(e.b);
    const s = e.a;
    const a = Math.round(e.h);
    const l = e.s.toFixed(1);
    const d = e.v.toFixed(1);
  ...
  function n(e, t, n) {
    Object.defineProperty(e, t, {
      get () {
        return this.__state.space === 'RGB' ? this.__state[t] : (I.recalculateRGB(this, t, n), this.__state[t]);
      },
      set (e) {
        this.__state.space !== 'RGB' && (I.recalculateRGB(this, t, n), (this.__state.space = 'RGB')),
        (this.__state[t] = e);
      },
    });
  }
  function o(e, t) {
    Object.defineProperty(e, t, {
      get () {
        return this.__state.space === 'HSV' ? this.__state[t] : (I.recalculateHSV(this), this.__state[t]);
      },
      set (e) {
        this.__state.space !== 'HSV' && (I.recalculateHSV(this), (this.__state.space = 'HSV')), (this.__state[t] = e);
      },
    });
  }
  function i(e) {
  ...
  function h(e, t, n) {
    if (
      ...
      S.extend(n, {
        options (t) {
          if (arguments.length > 1) {
            const o = n.__li.nextElementSibling;
      ...
      const o = new Q(n.object, n.property, { min: n.__min, max: n.__max, step: n.__step });
      S.each(['updateDisplay', 'onChange', 'onFinishChange', 'step', 'min', 'max'], (e) => {
        const t = n[e];
        const i = o[e];
        n[e] = o[e] = function () {
      ...
      const i = function (t) {
        if (S.isNumber(n.__min) && S.isNumber(n.__max)) {
          const o = n.__li.firstElementChild.firstElementChild.innerHTML;
          const i = n.__gui.__listening.indexOf(n) > -1;
          n.remove();
          const r = f(e, n.object, n.property, {
      ...
      n instanceof K
        ...
        : n instanceof Z
          ...
          : n instanceof $ &&
          (X.addClass(t, 'color'),
          (n.updateDisplay = S.compose((e) => (t.style.borderLeftColor = n.__color.toString()), e, n.updateDisplay)),
          n.updateDisplay());
    n.setValue = S.compose((t) => e.getRoot().__preset_select && n.isModified() && _(e.getRoot(), !0), t, n.setValue);
  }
  function p(e, t) {
    const n = e.getRoot();
    const o = n.__rememberedObjects.indexOf(t.object);
    if (o !== -1) {
      let i = n.__rememberedObjectIndecesToControllers[o];
      if (
        (void 0 === i && ((i = {}), (n.__rememberedObjectIndecesToControllers[o] = i)),
        (i[t.property] = t),
        n.load && n.load.remembered)
      ) {
        const r = n.load.remembered;
        let s = void 0;
  ...
  function f(e, t, n, o) {
    ...
    if (o.color) i = new $(t, n);
      ...
      const r = [t, n].concat(o.factoryArgs);
      i = ne.apply(e, r);
    }
  ...
  function v(e) {
    ...
    const s = (e.__preset_select = document.createElement('select'));
    if (
      ...
      const a = document.getElementById('dg-local-explain');
      const l = document.getElementById('dg-local-storage');
      (document.getElementById('dg-save-locally').style.display = 'block'),
      localStorage.getItem(m(e, 'isLocal')) === 'true' && l.setAttribute('checked', 'checked'),
      b(e, a),
      X.bind(l, 'change', () => {
        (e.useLocalStorage = !e.useLocalStorage), b(e, a);
      });
    }
    const d = document.getElementById('dg-new-constructor');
    X.bind(d, 'keydown', (e) => {
      !e.metaKey || (e.which !== 67 && e.keyCode !== 67) || le.hide();
    }),
    X.bind(n, 'click', () => {
  ...
  function x(e, t) {
    ...
    return (
      S.each(e.__rememberedObjects, (o, i) => {
        const r = {};
        const s = e.__rememberedObjectIndecesToControllers[i];
        S.each(s, (e, n) => {
  ...
  function E(e) {
    for (let t = 0; t < e.__preset_select.length; t++)
  ...
  const A = Array.prototype.forEach;
  ...
  var S = {
    ...
    each (e, t, n) {
      if (e)
        ...
        } else for (const r in e) if (t.call(n, e[r], r) === this.BREAK) return;
    },
    defer (e) {
      setTimeout(e, 0);
    },
  ...
  const R = function () {
    L = !1;
    const e = arguments.length > 1 ? S.toArray(arguments) : arguments[0];
    return (
      S.each(O, (t) => {
        if (t.litmus(e))
          return (
  ...
  const N = {
    hsv_to_rgb (e, t, n) {
      const o = Math.floor(e / 60) % 6;
      const i = e / 60 - Math.floor(e / 60);
      const r = n * (1 - t);
      const s = n * (1 - i * t);
      const a = n * (1 - (1 - i) * t);
      const l = [
  ...
  (I.recalculateRGB = function (e, t, n) {
    if (e.__state.space === 'HEX') e.__state[t] = N.component_from_hex(e.__state.hex, n);
    else {
  ...
  (I.recalculateHSV = function (e) {
    const t = N.rgb_to_hsv(e.r, e.g, e.b);
    ...
    get () {
      return (
        this.__state.space !== 'HEX' &&
            ((this.__state.hex = N.rgb_to_hex(this.r, this.g, this.b)), (this.__state.space = 'HEX')),
        this.__state.hex
      );
    },
    set (e) {
  ...
  var X = {
    ...
    fakeEvent (e, t, n, o) {
      ...
      const s = document.createEvent(r);
      switch (r) {
        case 'MouseEvents':
  ...
  var K = (function (e) {
    function t(e, n) {
      F(this, t);
      const o = V(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n));
      const i = o;
      return (
        (o.__prev = o.getValue()),
      ...
      P(t, [
        {
          key: 'setValue',
          value (e) {
            const n = D(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'setValue', this).call(this, e);
            return (
  ...
  const Y = (function (e) {
    function t(e, n, o) {
      F(this, t);
      const i = V(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n));
      let r = o;
      const s = i;
  ...
  var Q = (function (e) {
    function t(e, n, o) {
      ...
      F(this, t);
      const a = V(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n, o));
      ...
      return (
        ...
        X.bind(a.__input, 'change', () => {
          const e = parseFloat(l.__input.value);
        ...
        X.bind(a.__input, 'keydown', function (e) {
          e.keyCode === 13 && ((l.__truncationSuspended = !0), this.blur(), (l.__truncationSuspended = !1), i());
        }),
        a.updateDisplay(),
  ...
  var q = (function (e) {
    function t(e, n, o, i, r) {
      function s(e) {
        e.preventDefault();
        const t = _.__background.getBoundingClientRect();
      ...
      function d(e) {
        ...
        const n = _.__background.getBoundingClientRect();
      ...
      F(this, t);
      const u = V(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n, { min: o, max: i, step: r }));
      var _ = u;
      return (
        ...
        X.bind(u.__background, 'touchstart', (e) => {
          e.touches.length === 1 && (X.bind(window, 'touchmove', d), X.bind(window, 'touchend', c), d(e));
        }),
  ...
  var $ = (function (e) {
    function t(e, n) {
      ...
      function u(e) {
        ...
        const t = p.__saturation_field.getBoundingClientRect();
        const n = (e.touches && e.touches[0]) || e;
        const o = n.clientX;
        const i = n.clientY;
        let r = (o - t.left) / (t.right - t.left);
        let s = 1 - (i - t.top) / (t.bottom - t.top);
        return (
          s > 1 ? (s = 1) : s < 0 && (s = 0),
          r > 1 ? (r = 1) : r < 0 && (r = 0),
          (p.__color.v = s),
      ...
      function _(e) {
        e.type.indexOf('touch') === -1 && e.preventDefault();
        const t = p.__hue_field.getBoundingClientRect();
        let n = 1 - (((e.touches && e.touches[0]) || e).clientY - t.top) / (t.bottom - t.top);
        return n > 1 ? (n = 1) : n < 0 && (n = 0), (p.__color.h = 360 * n), p.setValue(p.__color.toOriginal()), !1;
      }
      F(this, t);
      const h = V(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n));
      ...
      P(t, [
        {
          ...
          value () {
            ...
            const n = this.__color.v < 0.5 || this.__color.s > 0.5 ? 255 : 0;
            const o = 255 - n;
  ...
  var he = function e(t) {
    ...
    let i = ae && localStorage.getItem(m(this, 'isLocal')) === 'true';
    let r = void 0;
    let s = void 0;
    if (
      ...
      if (
        ...
        n.useLocalStorage = !0;
        const a = localStorage.getItem(m(this, 'gui'));
      ...
      const l = document.createTextNode(o.name);
      X.addClass(l, 'controller-name'), (s = c(n, l));
      X.addClass(this.__ul, e.CLASS_CLOSED),
      X.addClass(s, 'title'),
      X.bind(s, 'click', (e) => e.preventDefault(), (n.closed = !n.closed), !1),
    ...
    (r = function () {
      ae &&
            localStorage.getItem(m(n, 'isLocal')) === 'true' &&
  ...
  (he._keydownHandler = function (e) {
    document.activeElement.type === 'text' || (e.which !== 72 && e.keyCode !== 72) || he.toggleHide();
  }),
  ...
  S.extend(he.prototype, {
    ...
    onResize () {
      ...
      if (e.scrollable) {
        const t = X.getOffset(e.__ul).top;
        let n = 0;
    ...
    remember () {
      ...
      S.each(Array.prototype.slice.call(arguments), (t) => {
        e.__rememberedObjects.length === 0 && v(e),
    ...
    listen (e) {
      const t = this.__listening.length === 0;
  ...
  const pe = { Color: I, math: N, interpret: R };
  const fe = {
    Controller: z,
    BooleanController: K,
    OptionController: Y,
  ...
  const ge = { GUI: he };
  const be = he;
  const ve = { color: pe, controllers: fe, dom: me, gui: ge, GUI: be };
  (e.color = pe),
  (e.controllers = fe),
  (e.dom = me),
  (e.gui = ge),
